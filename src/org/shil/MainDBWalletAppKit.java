 ...
 */
public class MainDBWalletAppKit extends AbstractIdleService {
    protected static final Logger log = LoggerFactory.getLogger(MainDBWalletAppKit.class);
...
//    protected volatile BlockStore vStore;
     ...
     */
    public MainDBWalletAppKit(NetworkParameters params, File directory, String filePrefix) {
     ...
     */
    public MainDBWalletAppKit(Context context, File directory, String filePrefix) {
    ...
    public MainDBWalletAppKit setPeerNodes(PeerAddress... addresses) {
    ...
    public MainDBWalletAppKit connectToLocalHost() {
        try {
    ...
    public MainDBWalletAppKit setAutoSave(boolean value) {
        checkState(state() == State.NEW, "Cannot call after startup");
        useAutoSave = value;
        return this;
    }
     ...
     */
    public MainDBWalletAppKit setDownloadListener(DownloadProgressTracker listener) {
        this.downloadListener = listener;
        return this;
    }

    /** If true, will register a shutdown hook to stop the library. Defaults to true. */
    public MainDBWalletAppKit setAutoStop(boolean autoStop) {
     ...
     */
    public MainDBWalletAppKit setCheckpoints(InputStream checkpoints) {
     ...
     */
    public MainDBWalletAppKit setBlockingStartup(boolean blockingStartup) {
     ...
     */
    public MainDBWalletAppKit setUserAgent(String userAgent, String version) {
     ...
     */
    public MainDBWalletAppKit setWalletFactory(WalletProtobufSerializer.WalletFactory walletFactory) {
     ...
     * time).
     */
    public MainDBWalletAppKit restoreWalletFromSeed(DeterministicSeed seed) {
     ...
     */
    public MainDBWalletAppKit setDiscovery(@Nullable PeerDiscovery discovery) {
...
//TODO            vStore = provideBlockStore(chainFile);
//            vStore = new PostgresFullPrunedBlockStore(params, 1000, "192.168.0.102", "btc", "postgres", "134120");
            vStore = new MySQLFullPrunedBlockStore(params, 1000, BTC.IPADDRESS, BTC.NAME, BTC.USER, BTC.PASSWORD);
            /*TODO
            ...
            */
//TODO            vChain = new BlockChain(params, vStore);
    ...
    private void installShutdownHook() {
        if (autoStop) Runtime.getRuntime().addShutdownHook(new Thread() {
            @Override public void run() {
                try {
                    MainDBWalletAppKit.this.stopAsync();
                    MainDBWalletAppKit.this.awaitTerminated();
                } catch (Exception e) {
                    throw new RuntimeException(e);
                }
            }
    ...
    public static void main(String[] args){
        try {
//        	Wallet n = new Wallet
//            Wallet n = new Wallet(MainNetParams.get());
//            System.out.println(n);
//            System.out.println("xxx" + n.currentReceiveKey());
//            System.out.println("yyy" + n.getKeyChainSeed());
//            DeterministicSeed seed = n.getKeyChainSeed();
...
//			DeterministicSeed seed = new DeterministicSeed("voyage magic immense beyond gadget trick seat sure monitor bundle nothing hold", null, "", 1519219881); //1392952170);
//			seed.check();
//			Wallet w = Wallet.fromSeed(MainNetParams.get(),seed);
...
//            System.out.println(kit.wallet());
            ...
            System.out.println("Seed words are: " + words);
            System.out.println("Seed birthday is: " + seed2.getCreationTimeSeconds());
            System.out.println("w:"+kit.wallet());
...
//            Address a = kw.currentReceiveAddress();
//            ECKey b = kw.currentReceiveKey();
//            Address c = kw.freshReceiveAddress();
